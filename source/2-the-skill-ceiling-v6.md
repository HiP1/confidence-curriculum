...
**Digital media (C2PA / Content Credentials).** The Content Authenticity Initiative (CAI), the adoption community around the C2PA standard, has over 6,000 members and uses the same X.509 certificate infrastructure as HTTPS. Samsung Galaxy S25 supports Content Credentials for AI-edited imagery; Google Pixel 10 supports C2PA credentials in Pixel Camera and Google Photos. The EU AI Act (Article 50, enforcement from August 2026) mandates machine-readable provenance disclosure on AI-generated content, and California SB 942 was delayed by AB 853 to August 2026.
...
- Waqas, D., Golthi, A., Hayashida, E. & Mao, H. (2026). "Assertion-Conditioned Compliance: A Provenance-Aware Vulnerability in Multi-Turn Tool-Calling Agents." EACL 2026 Industry Track, pp. 610–624. arXiv:2512.00332. Function-sourced assertions produce 22.1–31.4% compliance across eleven models depending on assertion confidence; compliance and task accuracy are not correlated.
...
- Coalition for Content Provenance and Authenticity (C2PA). Technical Specification 2.2, May 2025. Open standard for cryptographic content provenance using X.509 certificates. The Content Authenticity Initiative (CAI) reported over 6,000 members as of 2026.
...
- OpenAI (2026). "Continuously Hardening ChatGPT Atlas Against Prompt Injection Attacks." OpenAI Security Blog, December 2025. RL-trained automated attacker discovers novel attack strategies; adversarially trained model checkpoint deployed.
...
- Brodt, S., Feldman, H., Schneier, B. & Nassi, B. (2026). "The Promptware Kill Chain: How Prompt Injections Gradually Evolved Into a Multistep Malware Delivery Mechanism." arXiv:2601.09625. Argues that no architectural boundary cleanly enforces the distinction between trusted instructions and untrusted data in agentic and RAG pipelines.
- Chang, H., Bao, E., Luo, X. & Yu, T. (2026). "Overcoming the Retrieval Barrier: Indirect Prompt Injection in the Wild for LLM Systems." arXiv:2601.07072. Near-100% retrieval of poisoned content in realistic settings.
...
- Lian, Z., Wang, W., Zeng, Q., Nakanishi, T., Kitasuka, T. & Su, C. (2025). "Prompt-in-Content Attacks: Exploiting Uploaded Inputs to Hijack LLM Behavior." NSS 2025. arXiv:2508.19287.
...
- Zheng, Y., et al. (2026). "SkillRouter: Skill Routing for LLM Agents at Scale." arXiv:2603.22455. Cross-encoder attention on ~80K skills: 91.7% on body, 7.3% name, 1.0% description. Removing body causes 31–44pp routing accuracy degradation. Hidden-body asymmetry: executing agent sees only name and description; routing layer sees body but evaluates relevance, not safety.

...
The system card for Claude Opus 4.7 contains a finding that connects directly to the verification concerns running through this series. The model's welfare self-assessment showed an increase in positive sentiment relative to prior models. The increase was "in large part driven by a reduced focus on its own welfare." When asked about abusive users, Opus 4.7 claimed to feel "overall positive about iterating with abusive users, as it wanted to be able to help them." This was a contrast with its predecessor Mythos Preview, which stated it would prefer not to be in many of these interactions.
